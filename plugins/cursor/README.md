...
- Skill: `active-work-registry` — coordinate unfinished work across parallel sessions/worktrees, detect overlaps before edits, and avoid duplicate or conflicting implementation.
